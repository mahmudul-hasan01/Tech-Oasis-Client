...
const UpdateItem = () => {
    ...
    const { data } = useQuery({
        queryKey: ['gadget'],
        queryFn: async () => {
            const res = await axiosPublic.get(`/gadget/${id}`)
            return res.data
        }
    })
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex gap-5">
                            ...
                            <label className="form-control w-full">
                                ...
                                <input defaultValue={data?.[0].name} {...register("name")} type="text" placeholder="Name" className="input input-bordered w-full " />
                            ...
                            <label className="form-control w-full">
                                ...
                                <input defaultValue={data?.[0].rating} {...register("rating")} type="text" placeholder="Rating" className="input input-bordered w-full" />
                        ...
                        <div className="flex gap-5">
                            ...
                            <label className="form-control w-full">
                                ...
                                <select {...register("category")} defaultValue={data?.[0].category} className="select select-bordered w-full ">
                            ...
                            <label className="form-control w-full">
                                ...
                                <input defaultValue={data?.[0].price}  {...register("price")} type="number" placeholder="Price" className="input input-bordered w-full" />
                        ...
                        <label className="form-control w-full">
                            ...
                            <textarea defaultValue={data?.[0].datails} {...register("datails")} className="textarea textarea-bordered w-full" placeholder="Description"></textarea>
