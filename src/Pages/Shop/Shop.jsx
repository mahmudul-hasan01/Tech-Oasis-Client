            ...
            <div className="grid grid-cols-3">
                {
                    currentPost?.map(phone => <div key={phone.id} className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-20 mx-auto bg-white">
                        ...
                        <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
                            ...
                            <p className=" text-start pl-8 text-xl md:text-sm font-semibold">Price: {phone.price} &</p>
                        </div>
